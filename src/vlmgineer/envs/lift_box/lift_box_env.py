...
class LiftBoxEnv(BaseEnv):
    def __init__(
        ...
        **kwargs,
        ...
        self.start_box_pos = np.array([0.68, 0.0, 0.12])  # Starting position of the ball
        self.target_box_pos = np.array([0.68, 0.0, 0.25])
        self.box_scale = 0.2
    ...
    def _setup_environment(self):
        ...
        self.box = p.loadURDF("good_box/mobility.urdf", self.start_box_pos, useFixedBase=False, globalScaling=self.box_scale)
